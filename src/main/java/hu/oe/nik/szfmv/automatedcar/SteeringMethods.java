...
public class SteeringMethods {
     ...
     */
    static public double getCarHeading(Point2D frontWheel, Point2D backWheel) {
     ...
     * */
    static public double getSteerAngle (double wheelPosition) throws Exception {
     ...
     **/
    static public Point2D getFrontWheel(double carHeading, double halfWheelBase, Point2D carPosition) {
     ...
     **/
    static public Point2D getBackWheel(double carHeading, double halfWheelBase, Point2D carPosition) {
     ...
     **/
    static public Point2D getBackWheelDisplacement(double carHeading, double speed, double fps) {
     ...
     **/
    static public Point2D getFrontWheelDisplacement(double carHeading, double angularSpeed, double speed, double fps) {
     ...
     */
    static public Point2D getNewFrontWheelPosition(Point2D frontWheel, Point2D frontWheelDisplacement) {
     ...
     */
    static public Point2D getNewBackWheelPosition(Point2D backWheel, Point2D backWheelDisplacement) {
     ...
     * @return  Car position
     **/
    static public Point2D getCarPosition(Point2D frontWheel, Point2D backWheel) {
